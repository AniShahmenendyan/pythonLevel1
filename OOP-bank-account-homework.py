...
# 3. Ստեղծել Person կլաս, որը կունենա երկու instance attribute՝ name և ssn (հանրային ծառայությունների համարանիշ) ,
#     - սահմանել __str__ մեթոդը։ Այս մեթոդը մեզ ցույց կտա մարդու անունը
#     - սահմանել __repr__ մեթոդը։ Այս մեթոդը մեզ ցույց կտա մարդու հանրային ծառայությունների համարանիշը
